...
void plot_16bit_bitmap(UINT16 *base, INT16 row, INT16 col, UINT16 height, const UINT16 *bitmap_16) {
...
void plot_32bit_bitmap(UINT32 *base, INT16 row, INT16 col, UINT16 height, const UINT32 *bitmap_32) {
    UINT16 x_skip, y_skip, visible;
